package br.universidadejava.jpa.dao;
...
public class PessoaDAO {
    ...
    private EntityManager getEntityManager() {
        EntityManagerFactory factory = Persistence.createEntityManagerFactory("crud-persistencePU");
...
//        }
    ...
    public List<Pessoa> consultar() {
        ...
        try {
            ...
            Query query = entityManager.createNativeQuery(jpql, Pessoa.class);
